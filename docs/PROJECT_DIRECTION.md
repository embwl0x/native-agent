...
5. One command palette/search. Prefer a fast "Find anything" surface over more tabs, covering Telegram config, memory hygiene, provider settings, Capability Foundry, approvals, Doctor, logs, and skills.
...
- Autonomy Command Center: Mac Command Center should show the compact autonomy picture across proactive ideas, harness learning, Capability Foundry, self-improvement, promotion standards, and unified policy gates without adding another tab or hot-context inventory load.
