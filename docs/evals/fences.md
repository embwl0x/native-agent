...
| core.chat.persistence | Core/ChatOrchestration — message persistence, session history, compaction, metacognition/outcome tissue, turn trace emitters (ContextStageTrace, TurnContextSnapshotTrace), factories |
...
| app.mac | Sources/NativeAgentApp — MacIntegrationView, MacControlPermissionsView, MacPairingView, MacAssistantWatchSetupView, ActivityView, ActivityCapturePermissionsView, BrowserWindow, ResearchView, NativeExperienceView, ContentView/navigation, menu bar/status item, Spotlight, Update |
