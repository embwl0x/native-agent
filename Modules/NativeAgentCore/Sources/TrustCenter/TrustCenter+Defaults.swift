...
extension SwiftNativeTrustCenter {
    ...
    public nonisolated func defaultTrustPolicy() -> [String: JSONValue] {
        ...
        policy["chromeControlPolicy"] = .object([
            // Real Chrome carries the user's authenticated browsing session.
            // A fresh install must expose no socket and accept no traffic.
            "enabled": .bool(false),
        ])
    ...
    private static let defaultToolAutonomy: [String: JSONValue] = [
        ...
        "browser.chrome_fill": .string("confirm"),
        "browser.chrome_type": .string("confirm"),
        "browser.chrome_select": .string("confirm"),
        "browser.chrome_keypress": .string("confirm"),
        "browser.chrome_set_checked": .string("confirm"),
        "browser.chrome_double_click": .string("confirm"),
