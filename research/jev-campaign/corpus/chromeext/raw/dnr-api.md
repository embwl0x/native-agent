...
is case sensitive ( bug 449152902 ).
...
Use initiatorDomains instead The rule will only match network requests originating from the list of domains .
...
Use excludedInitiatorDomains instead The rule will not match network requests originating from the list of excludedDomains .
